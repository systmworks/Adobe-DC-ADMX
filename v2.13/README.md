...
|---|---|---|---|
| Disable and Lock JavaScript | `bDisableJavaScript` | Security: Execution & Protection | Globally disables and locks JavaScript execution. Added to **Security Hardening** page as Recommended (Disabled). |
...
- `bDisableJavaScript` also uses inverted logic: GPO **Disabled** = DWORD 1 = JavaScript is disabled and locked. This matches the registry semantics (1 = disable JS) but may be confusing in GPMC/Intune.
