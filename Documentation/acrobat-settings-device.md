...
| Update Watchdog Interval (Days) | ``iInterval`` | Days before Watchdog prompts manual update after a failed update. |
| Updater Log Level | ``iLogLevel`` | Updater log verbosity. |
