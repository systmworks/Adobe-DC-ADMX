...
Recommended and optional security settings for the combined v1.0 ADMX templates (Device scope).
...
| Security: Trust & Permissions | Unknown URL Access Policy | DWORD `1` | ![Recommended](https://img.shields.io/badge/Recommended-238636?style=flat-square) |
...
| Startup & Experience | Usage Measurement (legacy) | Set to ![Enabled](https://img.shields.io/badge/Enabled-238636?style=flat-square) | ![Optional](https://img.shields.io/badge/Optional-1f6feb?style=flat-square) |
