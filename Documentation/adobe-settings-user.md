...
Complete list of 267 unique Adobe DC settings (268 table entries where the same `ValueName` has more than one friendly name) in the combined v3.9 ADMX templates, grouped by product applicability.
