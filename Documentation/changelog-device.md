...
See [readme in v2.20](README.md) (includes **v2.19** release notes in the same file).
...
See [readme in v2.19](README.md) (includes **v2.18** release notes in the same file).
...
See [readme in v2.18](README.md) (includes **v2.17** release notes in the same file; version readmes do not link across folders).
...
See [readme in v2.17](README.md) (includes **v2.16** release notes in the same file; version readmes do not link across folders).
...
**No settings changes:** Policy definitions are unchanged from **v2.15** below; this drop updates ADMX/ADML-only metadata (`revision`/`minRequiredRevision` alignment and three-line localization root element layout for Group Policy interoperability). Omitted per the rule above; see [readme in v2.16](README.md).
