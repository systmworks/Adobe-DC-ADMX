...
**Current version: v3.1** (20 July 2026). Full version history: [Changelog (Combined)](../Documentation/changelog.md).
...
| ADMX / ADML `revision` | 3.1 |
| `minRequiredRevision` (`resources`) | 3.1 |
...
5. After upgrading from v3.0 to v3.1, re-verify **Usage Measurement (legacy)** if configured — **Disabled** now correctly writes telemetry **off** (DWORD 0).
