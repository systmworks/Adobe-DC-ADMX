...
Complete list of 142 Acrobat DC policies in the v2.12 ADMX templates, sorted by category.
...
| Thumbnail Insertion Bar | ``bShowInsertionBar`` | Enable the thumbnail insertion bar when hovering between thumbnails. |
...
| Export Entire Table Content | ``ExportEntireTableContent`` | TBD |
